        ...
        <nav className="w-[80%] h-[5.25rem] m-auto mt-7 bg-navbarBg text-center backdrop-blur-sm rounded-xl fixed left-[10%] border-[1px] border-dotted border-axsoterBlue">
            <div className="mx-16 flex items-center justify-between min-h-full">
                ...
                " max-lg:opacity-0"
                    ...
                    <li className="relative"><Link className="cursor-pointer tracking-wide text-2xl ease-in-out duration-500 hover:text-axsoterBlue" href="/">{general('homepage')}</Link></li>
                    <span className="lg:inline text-3xl text-[#333] mx-5 hidden">/</span>
                    <li className="relative"><Link className="cursor-pointer tracking-wide text-2xl ease-in-out duration-500 hover:text-axsoterBlue" href="/billing/products">{general('shop')}</Link></li>
                    <span className="lg:inline text-3xl text-[#333] mx-5 hidden">/</span>
                    <li className="relative"><Link className="cursor-pointer tracking-wide text-2xl ease-in-out duration-500 hover:text-axsoterBlue" href="/about">{general('about')}</Link></li>
                    <span className="lg:inline text-3xl text-[#333] mx-5 hidden">/</span>
                    <li className="relative"><Link className="cursor-pointer tracking-wide text-2xl ease-in-out duration-500 hover:text-axsoterBlue" href="/blog">{general('blog')}</Link></li>
                    <span className="lg:inline text-3xl text-[#333] mx-5 hidden">/</span>
                    <li className="relative"><Link className="cursor-pointer tracking-wide text-2xl ease-in-out duration-500 hover:text-axsoterBlue" target="_blank" href="https://axsoter.com/status/">{general('status')}</Link></li>
