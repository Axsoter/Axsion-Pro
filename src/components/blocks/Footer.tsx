...
export default function Footer() {
    ...
    return (
        <ScrollReveal>
            <footer className="bg-defaultBg w-[80%] mx-auto rounded-xl mb-4 border-2 border-dotted border-axsoterBlue">
                        ...
                        <div className="flex mt-0 sm:justify-center items-center">
                            <a href="/youtube" className="text-[#FF0000] hover:text-white">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 28.57 20" aria-hidden="true"><g>
                                    ...
                                    <path d="M11.4253 14.2854L18.8477 10.0004L11.4253 5.71533V14.2854Z" fill="currentColor" className="text-defaultBg" />
                                </g></svg>
